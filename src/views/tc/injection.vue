  ...
  <div class="root">
    ...
    <el-row :gutter="10">
      ...
      <el-col :span="6" style="text-align: right;">
          ...
          <el-button @click="handleInjectionQuery" slot="append" icon="el-icon-search"></el-button>
        </el-input>
			</el-col>

		</el-row>

    <el-table :data="injectionList" style="width: 100%">
...
<script>
  ...
  import { postInjectionsByPage } from '@/api/api_tc'
  ...
  export default {
    ...
    methods: {
      ...
      queryByPage() {
        ...
        postInjectionsByPage({ satelliteId, groundStationId, start, end, pageSize, currentPage }).then(response => {
			    console.log(response)
          if (response.code === 200) {
            const page = response.respBody
            this.total = page.total
            this.currentPage = page.currentPage
            this.injectionList = page.dataList
          }
		    })
      },
